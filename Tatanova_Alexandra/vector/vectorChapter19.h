...
void vector <T, A> :: reserve (int newalloc)
{
    ...
    vector_base<T,A> b(this->alloc, newalloc);// Здесь сбой!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!fkldnjndjbnjrsiohtgsohvuhuthvtuheuit!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    //std::uninitialized_copy (b.elem, &b.elem[this->sz],this->elem) ;// Копирование
    std::uninitialized_copy (elem, elem + sz, b.elem) ;// Копирование
    b.sz = sz;
    std::cout<<b.sz<<" "<<b.space<<"\n";
